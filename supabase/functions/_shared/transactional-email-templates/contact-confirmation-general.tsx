...
const GeneralConfirmationEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your enquiry has reached our studio</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your enquiry has reached our studio. A member of our team will review your message and respond personally within 48 hours.
        </Text>
        <Text style={text}>
          Whether you're at the beginning of a project or simply exploring what's possible, we look forward to being in touch.
        </Text>
        <Text style={text}>
          Should your matter be urgent, you're welcome to reach us directly:
        </Text>
...
export const template = {
  component: GeneralConfirmationEmail,
  subject: 'Your enquiry has reached our studio',
