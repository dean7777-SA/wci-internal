...
const ProjectConfirmationEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your project has reached our studio</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your project has reached our studio. A member of our team will review the details you've shared and respond personally within 48 hours.
        </Text>
        <Text style={text}>
          Every project we take on begins with a considered conversation — about the space, the atmosphere you're working toward, and the architectural intent behind it. We look forward to beginning that conversation with you.
        </Text>
        <Text style={text}>
...
export const template = {
  component: ProjectConfirmationEmail,
  subject: 'Your project has reached our studio',
