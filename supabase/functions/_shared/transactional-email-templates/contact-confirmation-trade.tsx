...
const TradeConfirmationEmail = ({ name }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your trade enquiry has reached our studio</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Your trade enquiry has reached our studio. A member of our team will be in touch within 48 hours to assist.
        </Text>
        <Text style={text}>
          We value our trade partners and the projects they bring to life, and we look forward to supporting yours.
        </Text>
        <Text style={text}>
          For direct assistance, please reach us on:
        </Text>
...
export const template = {
  component: TradeConfirmationEmail,
  subject: 'Your trade enquiry has reached our studio',
